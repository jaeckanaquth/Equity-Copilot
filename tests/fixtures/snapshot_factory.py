...
def make_snapshot(
    ...
    **overrides,
    ...
    """Create a valid StockSnapshot (usable outside pytest)."""
        ...
        for key, value in overrides.items():
            if key in flat_to_nested:
                ...
                if isinstance(value, (int, float)) and value is not None:
                    ...
                    value = [
                        Decimal(str(v)) if v is not None and isinstance(v, (int, float)) else v
                        for v in value
                    ]
...
def snapshot_factory():
    def _factory(
        ...
        **overrides,
        ...
        overrides.setdefault("metadata", {})["data_sources"] = ["test_fixture"]
